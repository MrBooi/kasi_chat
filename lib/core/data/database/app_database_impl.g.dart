...
class $ChatsTableTable extends ChatsTable
  ...
  static const VerificationMeta _userIdsMeta = const VerificationMeta(
    'userIds',
  );
  @override
  ...
  static const VerificationMeta _lastMessageUserIdMeta = const VerificationMeta(
    'lastMessageUserId',
  );
  @override
  ...
  ChatsTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ChatsTableData(
      ...
      userIds: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}user_ids'],
      )!,
      ...
      lastMessageUserId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}last_message_user_id'],
      ),
...
class ChatsTableData extends DataClass implements Insertable<ChatsTableData> {
  ...
  factory ChatsTableData.fromJson(
    ...
    return ChatsTableData(
      ...
      lastMessageUserId: serializer.fromJson<String?>(
        json['lastMessageUserId'],
      ),
